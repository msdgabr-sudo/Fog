...
checks = [
    ...
    (r"(?m)^\s*versionCode\s+4\b", "versionCode 4"),
...
# The previous Play release (code 3 / 3.1.0) used the same package. Any legacy
# or alternate package identifier in the generated application identity is fatal.
