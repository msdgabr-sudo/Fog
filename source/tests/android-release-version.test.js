...
for (const [file, tokens] of [
  ...
  ['source/android-twa/README.md', ['Version name: `4.1.7`', 'Version code: `4`']],
  ...
  ['.github/workflows/verify-release-snapshot.yml', ['QiblaAstro-4.1.7-code4-unsigned.aab', 'QiblaAstro-4.1.7-code4-unsigned-AAB-proof', '--skipVersionUpgrade']],
  ...
  ['source/android-twa/build_signed_release.ps1', ['Version: 4.1.7 (code 4)', '--skipVersionUpgrade']],
  ['build-final-signed-aab.ps1', ['Version: 4.1.7 (code 4)', 'QiblaAstro-4.1.7-code4-final.aab', 'QiblaAstro-4.1.7-code4-final.apk', '--skipVersionUpgrade']]
]) {
...
console.log('Android release identity: com.qiblalabs 4.1.7 (code 4), validation gates and APK/AAB artifact names: PASS');
