...
assert(bootstrap.includes('schedule-sync.js?v=20260826-widget-sync3'),'authenticated widget/prayer sync loader version missing');
const sw=read('service-worker.js');
assert(/qiblaastro-v\d+\.\d+-/.test(sw),'versioned service-worker cache missing');
assert(sw.includes('qiblaastro-v5.70-offline-native-20260826'),'offline/native service-worker version missing');
