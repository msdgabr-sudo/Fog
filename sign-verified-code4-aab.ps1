...
# This script signs only the exact unsigned AAB that passed the complete GitHub
# release workflow at commit eafcaf92eae8be276ad36f7884771a268ee1e968.
# It does not rebuild or modify application code.
$ApprovedSourceCommit = 'eafcaf92eae8be276ad36f7884771a268ee1e968'
$ApprovedUnsignedSha256 = 'A7F87CAD4F398D107BC6B77F59C4C724A23D5F9CAC594568D3D1CE15DBC17BB6'
...
Write-Host 'QiblaAstro 4.1.7 (code 4) — sign verified CI AAB locally' -ForegroundColor Cyan
...
Write-Host 'PASS: unsigned AAB is byte-for-byte the approved CI artifact.' -ForegroundColor Green
...
$HashFile = Join-Path $Dist 'QiblaAstro-4.1.7-code4-final.aab.sha256'
"$FinalHash  QiblaAstro-4.1.7-code4-final.aab" | Set-Content -LiteralPath $HashFile -Encoding ASCII
$ReportFile = Join-Path $Dist 'QiblaAstro-4.1.7-code4-SIGNING-REPORT.txt'
@"
...
Write-Host ''
Write-Host 'PASS: FINAL SIGNED GOOGLE PLAY AAB IS READY.' -ForegroundColor Green
